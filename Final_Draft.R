...
# In this project, we used stochastic simulation to investigate a somewhat surprising probability puzzle, 
# which is also known as the classic 2n prisoners problem. Here we conducted this investigation under three 
# strategies and compared the corresponding probabilities derived to find if there are surprising results.
# After estimating the probabilities of going free (finding their numbers), our next step, which is also the 
# core of our investigation, would be estimating the probability distribution of the number of steps 
# needed to go free.
...
# verify the total time of running the whole project
